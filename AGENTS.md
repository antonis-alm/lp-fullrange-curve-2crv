# LPFullRangeCurve2crvStrategy - Agent Guide

> AI coding agent context for the `l_p_full_range_curve_2crv` strategy.

## Overview

- **Template:** dynamic_lp
- **Chain:** arbitrum
- **Class:** `LPFullRangeCurve2crvStrategy` in `strategy.py`
- **Config:** `config.json`
